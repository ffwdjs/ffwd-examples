...
<!--[if gt IE 8]><!--> <html lang="<%= language  %>" class="no-js"> <!--<![endif]-->
  <head>
    ...
    <base href="/">
    <title><%- _.compact([name, appName]).join('|')  %></title>
      ...
      <div class="row">
        ...
        <section class="column medium-9">
          <header class="page">
            ...
            <h1 class="<%- (data.private ? 'private' : '') %>"><%- name %> <small><%- data.version %></small></h1>
            
            <% if (data.homepage) { %>
            <a href="<%- data.homepage %>" class="homepage">Site</div>
            <% } %>
          ...
          <div class="content">
            ...
            <div class="row">
              <div class="column">
                <div class="highlight">
                  <pre lang="js"><%= JSON.stringify(data, null, 2) %></pre>
                </div>
              </div>
            </div>
          </div>
